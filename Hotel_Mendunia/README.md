...
## IMPORTANT NOTE!!!
- In this program you dont need to create databse schemas, table and or insert the data to the table.
- If you successfully run the program you will see that the program will auto create the databse.
- In this project we use Visual Studio Code, XAMPP and PHPMyAdmin.
- If you have an error while running this program you just need to follow the advice/suggestion given.

## Installation & Running

1. unzip the folder:
   ```sh
   unzip the folder in any directory::
   ```

2. Navigate to the project directory terminal::
   ```sh
   cd Hotel_Mendunia
   ```
